...
public class ProductDtoService(IMapper mapper, IProductRepository productRepository) : IProductDtoService
{
    ...
    public async Task<IEnumerable<ProductDto>> GetProductsDtoByCategoriesAsync(string categoryStr)
    {
        try
        {
            var getProductByIdCategory = await _productRepository.GetProductsByCategoriesAsync(categoryStr);
        ...
        {
            throw new Exception("Unexpected error occurred while...", ex);
        }
    }
    ...
    public async Task<IEnumerable<ProductDto>> GetSearchProductDtoAsync(string keyword)
    {
        try
        {
            var getSearchProduct = await _productRepository.GetSearchProductAsync(keyword);
