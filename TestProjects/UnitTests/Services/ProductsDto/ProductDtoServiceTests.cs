...
namespace TestProjects.UnitTests.Services.ProductsDto;
...
public class ProductDtoServiceTests
{
    ...
    {
        // Arrange
        var productDtoService = Substitute.For<IProductDtoService>(); // Utiliza a interface IProductDtoService
    ...
    public async Task DeleteAsync_RemovesExistingProduct()
    {
        ...
        // Configurando GetByIdAsync para retornar um objeto ProductDto quando chamado com o ID específico
